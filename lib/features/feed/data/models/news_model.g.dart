...
const NewsModelSchema = CollectionSchema(
  ...
  indexes: {},
  links: {
    r'rssFeed': LinkSchema(
      id: -7040923330803642386,
      name: r'rssFeed',
...
NewsModel _newsModelDeserialize(
  ...
  final object = NewsModel(
    favorite: reader.readBoolOrNull(offsets[0]),
...
List<IsarLinkBase<dynamic>> _newsModelGetLinks(NewsModel object) {
  return [object.rssFeed];
}

void _newsModelAttach(IsarCollection<dynamic> col, Id id, NewsModel object) {
  object.id = id;
  object.rssFeed
      .attach(col, col.isar.collection<RssFeedModel>(), r'rssFeed', id);
}
...
extension NewsModelQueryFilter
  ...
  QueryBuilder<NewsModel, NewsModel, QAfterFilterCondition> favoriteIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NewsModel, NewsModel, QAfterFilterCondition> favoriteEqualTo(
      bool? value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NewsModel, NewsModel, QAfterFilterCondition> textIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'text',
      ));
  ...
  QueryBuilder<NewsModel, NewsModel, QAfterFilterCondition> textIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'text',
      ));
  ...
  QueryBuilder<NewsModel, NewsModel, QAfterFilterCondition> textEqualTo(
    String? value, {
  ...
  QueryBuilder<NewsModel, NewsModel, QAfterFilterCondition> textGreaterThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<NewsModel, NewsModel, QAfterFilterCondition> textLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<NewsModel, NewsModel, QAfterFilterCondition> textBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<NewsModel, NewsModel, QAfterFilterCondition> textStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NewsModel, NewsModel, QAfterFilterCondition> textEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NewsModel, NewsModel, QAfterFilterCondition> textContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NewsModel, NewsModel, QAfterFilterCondition> textMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NewsModel, NewsModel, QAfterFilterCondition> textIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'text',
        value: '',
  ...
  QueryBuilder<NewsModel, NewsModel, QAfterFilterCondition> textIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'text',
        value: '',
...
extension NewsModelQueryLinks
    on QueryBuilder<NewsModel, NewsModel, QFilterCondition> {
  QueryBuilder<NewsModel, NewsModel, QAfterFilterCondition> rssFeed(
      FilterQuery<RssFeedModel> q) {
    return QueryBuilder.apply(this, (query) {
      return query.link(q, r'rssFeed');
    });
  }

  QueryBuilder<NewsModel, NewsModel, QAfterFilterCondition> rssFeedIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'rssFeed', 0, true, 0, true);
    });
  }
}

extension NewsModelQuerySortBy on QueryBuilder<NewsModel, NewsModel, QSortBy> {
  QueryBuilder<NewsModel, NewsModel, QAfterSortBy> sortByFavorite() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'favorite', Sort.asc);
    });
  }

  QueryBuilder<NewsModel, NewsModel, QAfterSortBy> sortByFavoriteDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'favorite', Sort.desc);
    });
  }

  QueryBuilder<NewsModel, NewsModel, QAfterSortBy> sortByText() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'text', Sort.asc);
    });
  }

  QueryBuilder<NewsModel, NewsModel, QAfterSortBy> sortByTextDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension NewsModelQuerySortThenBy
  ...
  QueryBuilder<NewsModel, NewsModel, QAfterSortBy> thenByFavorite() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'favorite', Sort.asc);
    });
  }

  QueryBuilder<NewsModel, NewsModel, QAfterSortBy> thenByFavoriteDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'favorite', Sort.desc);
    });
  }
  ...
  QueryBuilder<NewsModel, NewsModel, QAfterSortBy> thenByText() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'text', Sort.asc);
    });
  }

  QueryBuilder<NewsModel, NewsModel, QAfterSortBy> thenByTextDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'text', Sort.desc);
    });
  }
...
extension NewsModelQueryWhereDistinct
  ...
  QueryBuilder<NewsModel, NewsModel, QDistinct> distinctByFavorite() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'favorite');
    });
  }

  QueryBuilder<NewsModel, NewsModel, QDistinct> distinctByText(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension NewsModelQueryProperty
  ...
  QueryBuilder<NewsModel, bool?, QQueryOperations> favoriteProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'favorite');
    });
  }

  QueryBuilder<NewsModel, String?, QQueryOperations> textProperty() {
    return QueryBuilder.apply(this, (query) {
